...
const ReviewCard = ({ review }) => {
  const { reviewer_name, days_ago, review_g } = review;
  return (
    <div>
      <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-700 text-gray-900 bg-gray-100">
        <div className="flex justify-between p-4">
          <div className="flex space-x-4">
            ...
            <div>
              ...
              <span className="text-xs text-gray-400">{days_ago} days ago</span>
            </div>
          </div>
        ...
        <div className="p-4 space-y-2 text-sm text-gray-400">
          <p>
            I needed to convert some documents urgently, and this website came
            to the rescue. It saved me a lot of time and hassle. Thank you for
