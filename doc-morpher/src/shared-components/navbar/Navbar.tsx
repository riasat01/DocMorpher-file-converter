                ...
                <ul className="absolute right-0 mt-2 p-2 w-52 bg-white border rounded shadow-md">
                  ...
                  <li>
                    <button
                      ...
                      className="w-full px-4 py-2 mt-2 text-lg font-semibold text-white rounded bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700"
                    >
                      Log Out
                    </button>
                  </li>
